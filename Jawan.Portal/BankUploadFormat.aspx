<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BankUploadFormat.aspx.cs" Inherits="Jawan.Portal.BankUploadFormat" %>
                                    ...
                                    <div class="dashboard_firsthalf" style="width: 100%">
                                        ...
                                        <table width="100%" cellpadding="5" cellspacing="5">
                                            <tr>
                                                ...
                                                <td>Month</td>
                                                <td>
                                                    <asp:TextBox ID="txtmonth" runat="server" Text="" class="sinput" AutoPostBack="true" OnTextChanged="txtmonth_TextChanged" ></asp:TextBox>
                                                ...
                                                <td style="margin-left: 40px">Options : </td>
                                                <td>
                                    ...
                                    <div class="rounded_corners">
                                        <asp:GridView ID="GVListClients" runat="server" AutoGenerateColumns="False" Width="90%" Style="margin: 0px auto"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="CARD NUMBER" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblCardNo" runat="server" Text='<%#Eval("EmpBankAcNo") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="CR/DR">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblCrDr" runat="server" Text='<%#Eval("CreditDebit") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>



                                                <asp:BoundField HeaderText="AMOUNT" DataField="ActualAmount" DataFormatString="{0:0.00}" ItemStyle-HorizontalAlign="Right" />

                                                <asp:TemplateField HeaderText="NARRATION">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblNaration" runat="server" Text='<%#Eval("Narration") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="CORPORATE ID">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblCorporateId" runat="server" Text='<%#Eval("CorporateID") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="MCC GROUP CODE">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblMccGrpCod" runat="server" Text="" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="EMP ID/DOB">
                                                    <ItemTemplate>
                                                        <%-- Text='<%#Eval("EmpId")%>' Text='<%#Eval("EmpDtofBirth") %>'--%>
                                                        <asp:Label ID="lblEmpId" runat="server" Text=""></asp:Label>
                                                        <br />
                                                        <asp:Label ID="lblEmpIdDob" runat="server" Text="" Style="text-align: left" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="REF NO">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblRefNo" runat="server" Text='<%#Eval("EmpBankCardRef") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="EMPLOYEE NAME">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblEmployeeName" runat="server" Text='<%#Eval("FullName") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
