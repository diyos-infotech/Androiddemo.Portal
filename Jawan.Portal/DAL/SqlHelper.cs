...
namespace KLTS.Data
{
    ...
    public class GlobalData
    {
        ...
        public DataTable LoadEmpNames(string EmpIdPrefix, string BranchID)
        {
        ...
        public DataTable LoadCIds(string ClientIdPrefix, string BranchID)
        {
        ...
        public DataTable LoadMainunitCIds(string ClientIdPrefix, string BranchId)
        {
        ...
        public DataTable LoadStaffIDs()
        {
            ...
            string Sqlqry = "select   Empid,Empid+' - '+(ISnull(Empfname,'')+' '+ Isnull(empmname,'')+' '+ isnull(Emplname,'') ) AS FullName  From Empdetails Order By Right(Empid,6)";
            System.Data.DataTable DtEmpIds = config.ExecuteAdaptorAsyncWithQueryParams(Sqlqry).Result;
            return DtEmpIds;
        }
        ...
        public DataTable LoadSourceofLeads()
        {

            string ProcedureName = "GetSourceofLeads";
            System.Data.DataTable DtSourceofLeads = config.ExecuteReaderWithSPAsync(ProcedureName).Result;
            return DtSourceofLeads;

        }
        public DataTable LoadLeadStatus()
        {

            string ProcedureName = "GetLeadStatus";
            System.Data.DataTable DtLeadStatus = config.ExecuteReaderWithSPAsync(ProcedureName).Result;
            return DtLeadStatus;
        ...
        public DataTable LoadGSTNumbers(string BranchID)
        {

            string ProcedureName = "GetGSTNos";
            Hashtable HtTblOptions = new Hashtable();
            HtTblOptions.Add("@BranchID", BranchID);
        ...
        public DataTable LoadActiveEmployeesOrderBy(string EmpidPrefix, string Branch, int OrderBy)
        {
            ...
            HtActiveEmployees.Add("@Branch", Branch);
            System.Data.DataTable DtActiveEmployees = config.ExecuteAdaptorAsyncWithParams(ProcedureName, HtActiveEmployees).Result;
