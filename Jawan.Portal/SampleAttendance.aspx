<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SampleAttendance.aspx.cs" Inherits="Jawan.Portal.SampleAttendance" %>
...
<head id="Head1" runat="server">
    ...
    <title>REPORT: SAMPLE ATTENDANCE REPORT</title>
                            ...
                            <div class="boxbody" style="padding: 5px 5px 5px 5px;">
                                <div class="boxin">
                                    ...
                                    <div class="rounded_corners" style="overflow: auto; width: 99%; margin-left: 17px">
                                        <asp:GridView ID="GVSampleAttendance" runat="server" AutoGenerateColumns="True"
