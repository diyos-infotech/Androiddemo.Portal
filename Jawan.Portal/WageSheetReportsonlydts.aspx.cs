...
{
    public partial class WageSheetReportsonlydts : System.Web.UI.Page
    {
        ...
        protected void loadallsalarydetails()
        {
            ...
            if (ddlclientid.SelectedIndex == 1)
            {
                sqlqry = "Select  EP.Empid,EP.Clientid,C.Clientname,(E.Empfname + E.EmpMname + E.emplname) as EmpMname ,EP.NoOfDuties," +
                          ...
                          " EP.gross as totalgross,EP.otamt,EP.Pfonduties as PF, (EP.Esionduties + EP.ESIonnhs) as ESI,EP.NHSAmt,EP.penalty,EP.owf,EP.saladvded,EP.CanteenAdv,EP.UniformDed,EP.OtherDed, " +
                          " EP.HRA,EP.CCA,EP.Conveyance,EP.OtherDed,EP.WashAllowance as  wa,d.Design,EP.Bonus,(EP.actualamount-EP.OTamt) as Netpay,  " +
                          ...
                          " '  and  EP.month=EA.Month  and  EP.Desgn=EA.Design  and   EP.Clientid=EA.Clientid " +
            ...
            sqlqry = "Select  EP.Empid,EP.Clientid,C.Clientname,(E.Empfname + E.EmpMname + E.emplname) as EmpMname ,EP.NoOfDuties," +
                  ...
                  " '  and  EP.month=EA.Month  and  EP.Clientid=EA.Clientid   and  EP.Desgn=EA.Design  " +
                  "   order By   Right(EP.Clientid,4) ,EP.empid";
