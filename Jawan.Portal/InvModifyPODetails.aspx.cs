...
namespace Jawan.Portal
{
    public partial class InvModifyPODetails : System.Web.UI.Page
    {
        ...
        {
            string date = "";
            string qry = "select DeliveryAt,clientid,isnull(Remarks,'') as Remarks,convert(varchar(10),DeliveryDate,103) as DeliveryDate,isnull(month,'') as month from InvPOMaster where pono='" + ddlPONo.SelectedValue + "'";
