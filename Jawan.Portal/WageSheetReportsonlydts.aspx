<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WageSheetReportsonlydts.aspx.cs" Inherits="Jawan.Portal.WageSheetReportsonlydts" %>
                                ...
                                <asp:GridView ID="GVListEmployees" runat="server" AutoGenerateColumns="False" Width="100%"
                                   CellSpacing="3" CellPadding="5" ForeColor="#333333" GridLines="None" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="nhs" HeaderText="NHs" DataFormatString="{0:0.00}" />
                                        ...
                                        <asp:BoundField DataField="NHSAmt" HeaderText="NHAmt" DataFormatString="{0:0.00}" />
                                        ...
                                        <asp:BoundField DataField="Netpay" HeaderText="Net AMount" DataFormatString="{0:0.00}" />
