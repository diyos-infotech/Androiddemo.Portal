    ...
    public partial class POPrint : System.Web.UI.Page
    {
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var GSTNO = string.Empty;
                string POContactPerson = "";
                string POContactNumber = "";
                ...
                if (compInfo.Rows.Count > 0)
                {
                    ...
                    GSTNO = compInfo.Rows[0]["GSTNO"].ToString();
                    POContactPerson = compInfo.Rows[0]["POContactPerson"].ToString();
                    POContactNumber = compInfo.Rows[0]["POContactNumber"].ToString();
                }
                ...
                string GstQry = "select GSTNo from GstMaster";
                DataTable DtGst = config.ExecuteAdaptorAsyncWithQueryParams(GstQry).Result;
                string companyGST = "";
                if (DtGst.Rows.Count > 0)
                {
                    companyGST = DtGst.Rows[0]["GSTNo"].ToString();
                }
                ...
                if (DTPOPrint.Rows.Count > 0)
                {
                    ...
                    VendorGSTNO = DTPOPrint.Rows[0]["VendorGSTNO"].ToString();
                }
                ...
                cell = new PdfPCell(new Paragraph("VENDORS NAME & ADDRESS", FontFactory.GetFont(FontStyle, 10, Font.BOLD, BaseColor.BLACK)));
                cell.HorizontalAlignment = 1; //0=Left, 1=Centre, 2=Right
                cell.BorderWidthBottom = 0;
                ...
                cell = new PdfPCell(new Paragraph("VendorGSTNO", FontFactory.GetFont(FontStyle, 10, Font.BOLD, BaseColor.BLACK)));
                cell.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right
                cell.BorderWidthBottom = 0.5f;
                cell.BorderWidthTop = 0;
                cell.BorderWidthLeft = 1.5f;
                ...
                cell = new PdfPCell(new Paragraph("GST No.: " + companyGST, FontFactory.GetFont(FontStyle, 10, Font.BOLD, BaseColor.BLACK)));
                cell.HorizontalAlignment = 1; //0=Left, 1=Centre, 2=Right
                cell.BorderWidthBottom = 0;
                cell.BorderWidthTop = 0.5f;
                cell.BorderWidthLeft = 0.5f;
                ...
                cell.Colspan = 1;
                Maintable.AddCell(cell);
                cell = new PdfPCell(new Paragraph(POContactPerson, FontFactory.GetFont(FontStyle, 10, Font.BOLD, BaseColor.BLACK)));
                cell.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right
                cell.BorderWidthBottom = 0;
                cell.BorderWidthTop = 0.5f;
                cell.BorderWidthLeft = 0;
                ...
                cell.Colspan = 1;
                Maintable.AddCell(cell);
                cell = new PdfPCell(new Paragraph(POContactNumber, FontFactory.GetFont(FontStyle, 10, Font.BOLD, BaseColor.BLACK)));
                cell.HorizontalAlignment = 0; //0=Left, 1=Centre, 2=Right
                cell.BorderWidthBottom = 0;
                cell.BorderWidthTop = 0.5f;
                cell.BorderWidthLeft = 0;
                ...
                PdfPTable Maintable1 = new PdfPTable(10);
                Maintable1.TotalWidth = 560f;
                Maintable1.LockedWidth = true;
                float[] Mainwidth1 = new float[] { 0.7f, 3f, 1f, 1.4f, 0.7f, 1f, 0.9f, 0.7f, 1f, 1.4f };
                ...
                cell.Colspan = 1;
                Maintable1.AddCell(cell);
                cell = new PdfPCell(new Paragraph("HSN No", FontFactory.GetFont(FontStyle, 10, Font.BOLD, BaseColor.BLACK)));
                cell.HorizontalAlignment = 1; //0=Left, 1=Centre, 2=Right
                cell.BorderWidthBottom = 0;
                cell.BorderWidthTop = 0.5f;
                cell.BorderWidthLeft = 0;
                ...
                cell.Colspan = 1;
                Maintable1.AddCell(cell);
                cell = new PdfPCell(new Paragraph("GST %", FontFactory.GetFont(FontStyle, 10, Font.BOLD, BaseColor.BLACK)));
                cell.HorizontalAlignment = 1; //0=Left, 1=Centre, 2=Right
                cell.BorderWidthBottom = 0;
                cell.BorderWidthTop = 0.5f;
                cell.BorderWidthLeft = 0;
                ...
                cell = new PdfPCell(new Paragraph("GST Amt", FontFactory.GetFont(FontStyle, 10, Font.BOLD, BaseColor.BLACK)));
                cell.HorizontalAlignment = 1; //0=Left, 1=Centre, 2=Right
                cell.BorderWidthBottom = 0;
                cell.BorderWidthTop = 0.5f;
                cell.BorderWidthLeft = 0;
                ...
                for (int i = 0; i < DTPOPrint.Rows.Count; i++)
                {
                    ...
                    GSTPer = DTPOPrint.Rows[i]["GSTPer"].ToString();
                    GSTAmt = DTPOPrint.Rows[i]["GSTAmt"].ToString();
                    HSNNumber = DTPOPrint.Rows[i]["HSNNumber"].ToString();
                    QtyandPrice = DTPOPrint.Rows[i]["QtyandPrice"].ToString();
                    ...
                    cell = new PdfPCell(new Paragraph(HSNNumber, FontFactory.GetFont(FontStyle, 10, Font.NORMAL, BaseColor.BLACK)));
                    cell.HorizontalAlignment = 1; //0=Left, 1=Centre, 2=Right
                    cell.BorderWidthBottom = 0;
                    cell.BorderWidthTop = 0.5f;
                    cell.BorderWidthLeft = 0;
                    ...
                    cell.Colspan = 1;
                    Maintable1.AddCell(cell);
                    cell = new PdfPCell(new Paragraph(QtyandPrice, FontFactory.GetFont(FontStyle, 10, Font.NORMAL, BaseColor.BLACK)));
                    ...
                    cell.Colspan = 1;
                    Maintable1.AddCell(cell);
                    cell = new PdfPCell(new Paragraph(GSTPer, FontFactory.GetFont(FontStyle, 10, Font.NORMAL, BaseColor.BLACK)));
                    cell.HorizontalAlignment = 1; //0=Left, 1=Centre, 2=Right
                    cell.BorderWidthBottom = 0;
                    cell.BorderWidthTop = 0.5f;
                    cell.BorderWidthLeft = 0;
                    ...
                    cell = new PdfPCell(new Paragraph(GSTAmt, FontFactory.GetFont(FontStyle, 10, Font.NORMAL, BaseColor.BLACK)));
                    cell.HorizontalAlignment = 1; //0=Left, 1=Centre, 2=Right
                    cell.BorderWidthBottom = 0;
                    cell.BorderWidthTop = 0.5f;
                    cell.BorderWidthLeft = 0;
                ...
                PdfPTable Maintable2 = new PdfPTable(10);
                Maintable2.TotalWidth = 560f;
                Maintable2.LockedWidth = true;
                float[] Mainwidth2 = new float[] { 0.7f, 3f, 1f, 1.4f, 0.7f, 1f, 0.9f, 0.7f, 1f, 1.4f };//0.7f, 3f, 1.7f, 1.7f, 1.9f, 2.8f
                ...
                cell = new PdfPCell(new Paragraph(totGSTAmt.ToString("#.##"), FontFactory.GetFont(FontStyle, 10, Font.BOLD, BaseColor.BLACK)));
                cell.HorizontalAlignment = 2; //0=Left, 1=Centre, 2=Right
                cell.BorderWidthBottom = 0.5f;
                cell.BorderWidthTop = 0.5f;
                cell.BorderWidthLeft = 0;
                ...
                cell = new PdfPCell(new Paragraph(Gtotal.ToString("#.##"), FontFactory.GetFont(FontStyle, 10, Font.BOLD, BaseColor.BLACK)));
                cell.HorizontalAlignment = 2; //0=Left, 1=Centre, 2=Right
                cell.BorderWidthBottom = 0.5f;
                cell.BorderWidthTop = 0.5f;
                cell.BorderWidthLeft = 0;
                ...
                if (VATCmp1per > 0)
                {
                    ...
                    cell.Colspan = 4;
                    Maintable2.AddCell(cell);
                    cell = new PdfPCell(new Paragraph(VATCmp1per.ToString("#.##"), FontFactory.GetFont(FontStyle, 10, Font.BOLD, BaseColor.BLACK)));
                    cell.HorizontalAlignment = 2; //0=Left, 1=Centre, 2=Right
                    cell.BorderWidthBottom = 0.5f;
                    cell.BorderWidthTop = 0;
                    cell.BorderWidthLeft = 0;
                ...
                if (VATCmp2per > 0)
                {
                    ...
                    cell.Colspan = 4;
                    Maintable2.AddCell(cell);
                    cell = new PdfPCell(new Paragraph(VATCmp2per.ToString("#.##"), FontFactory.GetFont(FontStyle, 10, Font.BOLD, BaseColor.BLACK)));
                    cell.HorizontalAlignment = 2; //0=Left, 1=Centre, 2=Right
                    cell.BorderWidthBottom = 0.5f;
                    cell.BorderWidthTop = 0;
                    cell.BorderWidthLeft = 0;
                ...
                if (VATCmp3per > 0)
                {
                    ...
                    cell.Colspan = 4;
                    Maintable2.AddCell(cell);
                    cell = new PdfPCell(new Paragraph(VATCmp3per.ToString("#.##"), FontFactory.GetFont(FontStyle, 10, Font.BOLD, BaseColor.BLACK)));
                    cell.HorizontalAlignment = 2; //0=Left, 1=Centre, 2=Right
                    cell.BorderWidthBottom = 0.5f;
                    cell.BorderWidthTop = 0;
                    cell.BorderWidthLeft = 0;
                ...
                if (VATCmp4per > 0)
                {
                    ...
                    cell.Colspan = 4;
                    Maintable2.AddCell(cell);
                    cell = new PdfPCell(new Paragraph(VATCmp4per.ToString("#.##"), FontFactory.GetFont(FontStyle, 10, Font.BOLD, BaseColor.BLACK)));
                    cell.HorizontalAlignment = 2; //0=Left, 1=Centre, 2=Right
                    cell.BorderWidthBottom = 0.5f;
                    cell.BorderWidthTop = 0;
                    cell.BorderWidthLeft = 0;
                ...
                if (VATCmp5per > 0)
                {
                    ...
                    cell.Colspan = 4;
                    Maintable2.AddCell(cell);
                    cell = new PdfPCell(new Paragraph(VATCmp5per.ToString("#.##"), FontFactory.GetFont(FontStyle, 10, Font.BOLD, BaseColor.BLACK)));
                    cell.HorizontalAlignment = 2; //0=Left, 1=Centre, 2=Right
                    cell.BorderWidthBottom = 0.5f;
                    cell.BorderWidthTop = 0;
                    cell.BorderWidthLeft = 0;
                ...
                float totalamt = 0;
                totalamt = Convert.ToSingle(Gtotal) + Convert.ToSingle(VATCmp1per) + Convert.ToSingle(VATCmp2per) + Convert.ToSingle(VATCmp3per) + Convert.ToSingle(VATCmp4per) + Convert.ToSingle(VATCmp5per);
                ...
                string GTotalv = totalamt.ToString("#");
                string inwords = "";
                string rupee = "";
                string paise = "";
                ...
                rupee = NumberToEnglish.Instance.NumbersToWords(Convert.ToInt64(GTotalv), false);
                ...
                cell.Colspan = 10;
                Maintable2.AddCell(cell);
                cell = new PdfPCell(new Paragraph("Payment will be made within 30 days from reciept of the materials\nPlease submit the Original invoice with the acknowledged DC at the office within 3 days from delivery\nPayment will be made by cheque of RTGS", FontFactory.GetFont(FontStyle, 10, Font.NORMAL, BaseColor.BLACK)));
