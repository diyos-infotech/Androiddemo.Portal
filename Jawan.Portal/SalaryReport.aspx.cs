...
namespace Jawan.Portal
{
    public partial class SalaryReport : System.Web.UI.Page
    {
        ...
        protected void Binddata()
        {
            ...
            ProcedureName = "ReportForSalary";

            HtSalary.Add("@Month", month);
            HtSalary.Add("@Clientid", Clientid);

            dt = config.ExecuteAdaptorAsyncWithParams(ProcedureName, HtSalary).Result;
