...
namespace Jawan.Portal
{
    public partial class ModifyInvVendorMaster : System.Web.UI.Page
    {
        ...
        public void GetData()
        {
            string qry = "select vendorid,vendorname,ContactPerson,ContactNo,Address,Remarks,EMailId,VendorGSTNO from InvVendorMaster where vendorid='" + ddlVendorID.SelectedValue + "'";
