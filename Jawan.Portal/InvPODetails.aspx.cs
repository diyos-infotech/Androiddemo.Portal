...
namespace Jawan.Portal
{
    public partial class InvPODetails : System.Web.UI.Page
    {
        ...
        public void GetGridData()
        {
            ...
            string StockInHand = ""; string VAT = ""; string Total = ""; string SubTotal = ""; string VATfourteen = ""; string VATfive = "";
            int status = 0;
            try
            {
                ...
                for (int i = 0; i < GVInvPODetails.Rows.Count; i++)
                {
                    ...
                    // if (chkitemid.Checked == true)
                    {
                        ...
                        string sqlqry = "insert into InvPOMaster(pono,vendorid,itemid,Qty,StockInHand,BuyingPrice,VAT5per,VAT14per,Total,GSTAmt) values('" + txtPONo.Text + "','" + ddlVendorID.SelectedValue + "','" + itemid + "','" + Quantity + "','" + StockInHand + "','" + buyingprice + "','" + VATfive + "','" + VATfourteen + "','" + Total + "','" + GSTAmt + "')";
        ...
        public void GetGridDataintoTable()
        {
            ...
            try
            {
                ...
                string sqry = "select isil.itemname,HSNNumber,ivim.ItemId,isil.UnitMeasure,GSTPer,ivim.BuyingPrice,isil.actualquantity," +
