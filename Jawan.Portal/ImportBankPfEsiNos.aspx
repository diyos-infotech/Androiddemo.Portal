<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportBankPfEsiNos.aspx.cs" Inherits="Jawan.Portal.ImportBankPfEsiNos" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>IMPORT BANK/PF/ESI NOS.</title>
                            ...
                            <div class="boxin">
                                ...
                                <div class="dashboard_firsthalf" style="width: 100%">
                                    <table width="60%" cellpadding="5" cellspacing="5">
                                        <tr>
                                            <td>
                                                Select Sheet :<span style="color: Red">*</span>
                                            </td>
                                            <td>
                                             ...
                                             <td>
                                               <asp:Button ID="btnImport" Text="Import" runat="server"  class="btn save" 
