...
{
    public partial class BankUploadingFormatReport : System.Web.UI.Page
    {
        ...
        protected void Binddata()
        {
            ...
            var ProcedureName = "";
            var Clientid = "";
            Hashtable HtBank = new Hashtable();
            ...
            ProcedureName = "ReportForBankUploadingFormat";

            HtBank.Add("@Month", month);
            HtBank.Add("@Clientid", Clientid);

            dt =config.ExecuteAdaptorAsyncWithParams(ProcedureName, HtBank).Result;
        ...
        {
            gve.Export("BankUploadFormat.xls", this.GVListEmployees);
        }
    }
}