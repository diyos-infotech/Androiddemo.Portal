...
{
    public partial class CreatePocketFameLogin : System.Web.UI.Page
    {
        ...
        public void GetData()
        {
            ...
            string ChkQry = "select * from Logindetails_Android where companyid=6 and EmpId='" + txtEmpid.Text + "' ";
        ...
        protected void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            if (result > 0)
            {
                ...
                if (chkresult.Rows.Count > 0)
                {
                    string updatequery = "Update Logindetails_Android set UserName='" + txtusrname.Text.Trim() + "',Password='" + txtConfirmPassword.Text.Trim() + "',UpdatedDateTime=getdate(),Role='" + ddlrole.SelectedValue + "' where empid='" + Empid + "' and companyid=6";
                ...
                {
                    string insertquery = "insert into Logindetails_Android (Id,	EmpId,	UserName,	Password,	CompanyId,	CreatedDateTime	,UpdatedDateTime,	EmailId	,Role,	PushCode,	Rated	,ClientId) values (newid(),'" + txtEmpid.Text + "','" + txtusrname.Text.Trim() + "','" + txtConfirmPassword.Text.Trim() + "',6,Getdate(),'','','" + ddlrole.SelectedValue + "','',0,'')";
