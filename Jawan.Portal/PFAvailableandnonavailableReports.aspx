<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PFAvailableandnonavailableReports.aspx.cs" Inherits="Jawan.Portal.PFAvailableandnonavailableReports" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>REPORT: PF AVAILABILITY REPORT</title>
        ...
        <div class="content-holder">
           <div id="breadcrumb">
                <ul class="crumbs">
                    ...
                    <li class="active"><a href="#" style="z-index: 7;" class="active_bread">PF/ESI Details</a></li>
                </ul>
            </div>
                       ...
                       <div class="dashboard_firsthalf" style="width: 100%">
                            <div align="right">
                                ...
                                <td><asp:DropDownList ID="ddlpfesioptions" runat="server"  class="sdrop"
                                        AutoPostBack="true" 
                                        onselectedindexchanged="ddlpfesioptions_SelectedIndexChanged">
                               ...
                               <%-- <asp:ListItem>ESI</asp:ListItem>--%>
                                 ...
                                 <td>Please Select Available/Unavailable :</td>
                               <td><asp:DropDownList ID="ddlavailbleunavailbleoptions" runat="server"  class="sdrop"
                                       AutoPostBack="true" 
                                       onselectedindexchanged="ddlpfesioptions_SelectedIndexChanged"  > 
                            ...
                            <div class="rounded_corners">
                                <asp:GridView ID="GVpfesiemployees" runat="server" AutoGenerateColumns="False" Width="100%"
                                    Height="50px" CellPadding="5" CellSpacing="3" ForeColor="#333333" GridLines="None" style="text-align:center">
                                    <RowStyle BackColor="#EFF3FB" Height="30"/>
                                    <Columns>
                                        <asp:BoundField HeaderText="EmpID" DataField="EMpid"  />
                                        <asp:BoundField HeaderText="Name" DataField="name"  />
                                         <asp:BoundField HeaderText="Designation" DataField="Design"  />
                                        <asp:BoundField HeaderText="PFNo" DataField="EmpEpfno" />
                                    </Columns>
