<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PocketFaMECredentials.aspx.cs" Inherits="Jawan.Portal.PocketFaMECredentials" %>
            ...
            <div class="content-holder">
                <div id="breadcrumb">
                    <ul class="crumbs">
                        ...
                        <li class="active"><a href="#" style="z-index: 7;" class="active_bread">Pocket FaME Credentials</a></li>
                    </ul>
                </div>
                ...
                <div class="contentarea" id="contentarea">
                    <div class="dashboard_center">
                        <div class="sidebox">
                            <div class="boxhead">
                                <h2 style="text-align: center">Pocket FaME Credentials
                                </h2>
                            </div>
                            <div class="boxbody" style="padding: 5px 5px 5px 5px;">
                                <div class="boxin">
                                    ...
                                    <table width="100%" cellpadding="5" cellspacing="5">
                                        ...
                                        <tr>
                                            ...
                                            <td>Unit Name</td>
                                            <td>
                                                <asp:DropDownList ID="ddlcname" runat="server" CssClass="ddlautocomplete chosen-select" TabIndex="1" AutoPostBack="true" Style="width: 250px"
                                ...
                                <div style="width: 100%;margin-top:20px ">
                                    <asp:GridView ID="GVData" runat="server" AutoGenerateColumns="True" Width="90%" Style="margin: 0px auto"
                                        CellSpacing="3" CellPadding="5" ForeColor="#333333" GridLines="None" CssClass="table table-striped table-bordered table-condensed table-hover">
                                        <Columns>
                                        </Columns>
                                    </asp:GridView>
                                </div>
