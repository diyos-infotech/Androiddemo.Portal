<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProfTaxDeductionReports.aspx.cs" Inherits="Jawan.Portal.ProfTaxDeductionReports" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>REPORT: PT DEDUCTION REPORT</title>
...
<body>
    <form id="ProfTaxDeductionReports1" runat="server">
        ...
        <div class="content-holder">
            <div id="breadcrumb">
                <ul class="crumbs">
                    ...
                    <li class="active"><a href="#" style="z-index: 7;" class="active_bread">Prof.Tax Deductions</a></li>
                </ul>
            </div>
                                ...
                                <div class="rounded_corners">
                                    <asp:GridView ID="GVListEmployees" runat="server" AutoGenerateColumns="False" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Professional Tax Deductions">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblptded" Text="<%# Bind('ptded') %>"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                ...
                                <div>
                                    <table width="100%" cellpadding="5" cellspacing="3">
                                        <tr style="width: 100%; font-weight: bold">
                                            ...
                                            <td>
                                                <asp:Label ID="lbltmtpfd" runat="server" Text=""></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lbltgross" runat="server" Text=""></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
