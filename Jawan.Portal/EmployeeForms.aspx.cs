...
namespace Jawan.Portal
{
    public partial class EmployeeForms : System.Web.UI.Page
    {
        ...
        protected void btnform3a_Click(object sender, EventArgs e)
        {
            ...
            string strQry = "Select p.EmpEpfNo,e.EmpESINo from EMPESICodes AS e INNER JOIN EMPEPFCodes as p ON e.Empid = p.Empid AND e.Empid='" + ddlEmployee.SelectedValue + "'";
            string pfNo = "";
        ...
        protected void btnform13_Click(object sender, EventArgs e)
        {
            ...
            string prevqry = " select PFNo,YrOfExp,Designation,CompAddress,DateofResign from EmpPrevExperience where empid='" + ddlEmployee.SelectedValue + "'";
            ...
            tablesnewone.TotalWidth = 500f;
            tablesnewone.LockedWidth = true;
            float[] width = new float[] { 4f, 1.5f, 3f, 1.5f };
            tablesnewone.SetWidths(width);
        ...
        protected void btngratuity_Click(object sender, EventArgs e)
        {
            ...
            if (dtEmpdetails.Rows.Count > 0)
            {
                ...
                string filename = ddlempname.SelectedItem.Text + "/FormF(Gratuity).pdf";
        ...
        protected void btnFormQ_Click(object sender, EventArgs e)
        {
            ...
            if (dtEmpdetails.Rows.Count > 0)
            {
                ...
                string filename = ddlempname.SelectedItem.Text + "/FormQ.pdf";
        ...
        protected void btnFormA_Click(object sender, EventArgs e)
        {
            ...
            if (dtEmpdetails.Rows.Count > 0)
            {
                ...
                string filename = ddlempname.SelectedItem.Text + "/FormA.pdf";
        ...
        protected void btnFormLeaveWages_Click(object sender, EventArgs e)
        {
            ...
            if (dtEmpdetails.Rows.Count > 0)
            {
                ...
                string filename = ddlempname.SelectedItem.Text + "FormF(LeaveWages).pdf";
