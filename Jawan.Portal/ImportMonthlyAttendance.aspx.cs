...
namespace Jawan.Portal
{
    public partial class ImportMonthlyAttendance : System.Web.UI.Page
    {
        ...
        //region start swathi 28/05/2015
        ...
        protected void PreviligeUsers(string previligerid)
        {
            if (previligerid != "1")
            {
                ...
                #region Begin New Code As on [23-01-2014]


                #endregion End  New Code As on [23-01-2014]
            }
        ...
        public void VisibleLinks(int RoleId, int RowCount, int StartIndex)
        {
            #region Starting Role ID

            if (StartIndex == 0)
            {
                Session["StartRoleID"] = RoleId;
            }
            ...
            if (RoleId >= 29 && RoleId <= 36)
            {
                InventoryLink.Visible = true;
            }
            if (RoleId >= 37 && RoleId <= 78)
            {
                ReportsLink.Visible = true;
            }
            if (RoleId >= 79 && RoleId <= 90)
            {
                SettingsLink.Visible = true;
            }

            #region   Visible Links

            switch (RoleId)
            {
                case 1: AddEmployeeLink.Visible = true;
                    break;
                case 2: ModifyEmployeeLink.Visible = true;
                    break;
                case 3: DeleteEmployeeLink.Visible = true;
                    break;
                case 4: AssigningWorkerLink.Visible = true;
                    break;
                case 5: AttendanceLink.Visible = true;
                    break;
                case 6: LoanLink.Visible = true;
                    break;
                case 11: PaymentLink.Visible = true;
                    break;
                case 12: PostingOrderListLink.Visible = true;
                    break;
            ...
            #region  Redirecting PAges

            if (Session["FirstLoginRole"] == "0")
            {

                if (++StartIndex == RowCount)
                {
                    RoleId = int.Parse(Session["StartRoleID"].ToString());
                    switch (RoleId)
                    {
                        ...
                        case 1: AddEmployeeLink.Visible = true;
                            break;
                        case 2: ModifyEmployeeLink.Visible = true;
                            Response.Redirect("ModifyEmployee.aspx");
                            break;
                        case 3: DeleteEmployeeLink.Visible = true;
                            Response.Redirect("DeleteEmployee.aspx");
                            break;
                        case 4: AssigningWorkerLink.Visible = true;
                            Response.Redirect("AssingingWorkers.aspx");
                            break;
                        case 5: AttendanceLink.Visible = true;
                        ...
                        case 6: LoanLink.Visible = true;
                            ...
                            break;
                        case 11: PaymentLink.Visible = true;
                            Response.Redirect("EmployeePayments.aspx");
                            break;
                        case 12: PostingOrderListLink.Visible = true;
            ...
            else
            {
                ...
                string SqlQryForCheckRole = "select * from  RolesForPreviligersTwo  where roleid='1'  and previligedid='" + Session["AccessLevel"] + "'";
                DataTable DtCheckRole = config.ExecuteAdaptorAsyncWithQueryParams(SqlQryForCheckRole).Result;
                if (DtCheckRole.Rows.Count == 0)
                {

                    #region Second Time Redirected To  Target Page

                    SqlQryForCheckRole = "select * from  RolesForPreviligersTwo  where roleid " +
                        "  between '2' and   '15' and previligedid='" + Session["AccessLevel"] + "' order by roleid";
                    DtCheckRole = config.ExecuteAdaptorAsyncWithQueryParams(SqlQryForCheckRole).Result;
                    if (DtCheckRole.Rows.Count > 0)
                    {
                        int roleid = int.Parse(DtCheckRole.Rows[0]["roleid"].ToString());
        ...
        protected void btnImport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (ddlAttendanceMode.SelectedIndex == 0)
                {
                    ...
                    string qry = "select [Client Id],[Emp Id],[Designation],[Duties],[OTs],[WOs],[NHS] " +
        ...
        protected void lnkImportfromexcel_Click(object sender, EventArgs e)
        {
            if (ddlAttendanceMode.SelectedIndex == 0)
            {
                gve.Export("Employee Attendance.xls", this.grvSample2);
            }
            if (ddlAttendanceMode.SelectedIndex == 1)
            {
                gve.Export("Employee Attendance.xls", this.SampleGrid);
            }
        }
        ...
        {
            gve.Export("Employee Attendance.xls", this.GridView1);
        }
    }
}