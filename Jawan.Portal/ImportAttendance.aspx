<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportAttendance.aspx.cs" Inherits="Jawan.Portal.ImportAttendance" %>
                                ...
                                <div style="display: inline;">
                                  ...
                                  <div class="submenuactions">
                                        ...
                                        <ul>
                                            ...
                                            <li class="current"><a href="ImportAttendance.aspx" id="ImportMonthlyAttendanceLink" runat="server">
                                ...
                                <div>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <%-- <td>
                                                 <asp:Button ID="btnGetdata" runat="server" Text="Get Data"  class=" btn save" OnClick="btnGetdata_Click"/> 
                                                </td>--%>
                                        </tr>
                                        <tr>
                                ...
                                <div>
                                    ...
                                    <div class="rounded_corners">
                                        <asp:GridView ID="GVEmployeeList" runat="server" Width="80%" Style="margin: 0px auto" Visible="false"
                                            AutoGenerateColumns="False" CellPadding="5" CellSpacing="5" ForeColor="#333333" GridLines="None">
                                            <RowStyle BackColor="#EFF3FB" />
                                            <Columns>
