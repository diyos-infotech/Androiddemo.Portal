...
{
    public partial class ExpensesExpenditureReport : System.Web.UI.Page
    {
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "show alert", "alert('Please Select The Purpose Name');", true);
                return;
            }
            ...
            var ReportType = 0;
            var PurposeId = "0";
            DataTable DtExpensesExpenditure = null;
            Hashtable HtExpensesExpenditure = new Hashtable();
            ...
            PurposeId = Ddl_Purpose.SelectedValue;
            ...
            HtExpensesExpenditure.Add("@GetDate", GetDate);
            HtExpensesExpenditure.Add("@ReportType", ReportType);
            HtExpensesExpenditure.Add("@PurPoseId", PurposeId);

            SPName = "ReportForExpensesExpenditure";
            ...
            DtExpensesExpenditure = config.ExecuteAdaptorAsyncWithParams(SPName, HtExpensesExpenditure).Result;
            if (DtExpensesExpenditure.Rows.Count > 0)
            {
                GV_ExpensesExpenditure.DataSource = DtExpensesExpenditure;
