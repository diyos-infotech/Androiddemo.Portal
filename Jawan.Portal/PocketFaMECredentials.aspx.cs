...
{
    public partial class PocketFaMECredentials : System.Web.UI.Page
    {
        string CmpIDPrefix = "";
        string BranchID = "";
        ...
        protected void btn_Submit_Click(object sender, EventArgs e)
        {
            if (ddlclientid.SelectedIndex == 0)
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "showlalert", "alert('Please Select Unit ID/Name');", true);
            ...
            string SPName = "PocketFaMECredentials";
        ...
        {
            gve.Export("Pocket FaME Credentials.xls", this.GVData);
        }
    }
}