<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PfDeductionreports.aspx.cs" Inherits="Jawan.Portal.PfDeductionreports" %>
...
<head id="Head1" runat="server">
    ...
    <title>REPORT: PF DEDUCTION REPORT</title>
...
<body>
    <form id="PfDeductionreports1" runat="server">
        ...
        <div class="content-holder">
            <div id="breadcrumb">
                <ul class="crumbs">
                    ...
                    <li class="active"><a href="#" style="z-index: 7;" class="active_bread">PF Deductions</a></li>
                </ul>
            </div>
                   ...
                   <div class="dashboard_center">
                    ...
                    <asp:ScriptManager runat="server" ID="ScriptEmployReports"></asp:ScriptManager>
                      <div class="dashboard_firsthalf" style="width: 100%">
                       ...
                       <tr> <td>Select Date<span style=" color:Red">*</span> </td>
                     <td>
                       <asp:TextBox  ID="txtstartdate" runat="server" class="sinput" ></asp:TextBox>
                       <cc1:CalendarExtender ID="CEStartdate" runat="server" TargetControlID="txtstartdate" Enabled="True" Format="dd/MM/yyyy">
                     ...
                     <td>  <asp:Button  ID="btnsearch" runat="server" class=" btn save"  Text="Search" 
                               ...
                               <div class="rounded_corners">
                                <asp:GridView ID="GVListEmployees" runat="server" AutoGenerateColumns="False" Width="100%" Height="50px"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Employee Pf">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblepf" Text="<%# Bind('Emppf') %>"></asp:Label>
                                            </ItemTemplate>
                           ...
                           <table width="100%" cellpadding="5" cellspacing="3" >
                            ...
                            <td>&nbsp;</td>
                            <td>
                            <asp:Label ID="lbltmtemppf" runat="server" Text=""></asp:Label></td>
                            <td> <asp:Label ID="lbltemprpf" runat="server" Text=""></asp:Label>
                             </td>
                            </tr>
                            </table>
                            </div>
