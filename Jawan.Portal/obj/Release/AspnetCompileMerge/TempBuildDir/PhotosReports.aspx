<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PhotosReports.aspx.cs" Inherits="Jawan.Portal.PhotosReports" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>REPORTS: PHOTOGRAPHS REPORT</title>
...
<body>
  <form id="PhotosReports1" runat="server">
                                ...
                                <div id="submenu" class="submenu">
                                  <div class="submenubeforegap">
                                    ...
                                    <div class="submenuactions">
                                        &nbsp;</div>
                                 <ul>
                                      <li class="current"><a href="ActiveEmployeeReports.aspx" id="saleslink" runat="server"><span>Employees</span></a></li>
                ...
                <ul>
                   <li class="left leftmenu">
                       <ul>
                          ...
                          <li><a href="PhotosReports.aspx" class="sel">Photos </a>   </li>
