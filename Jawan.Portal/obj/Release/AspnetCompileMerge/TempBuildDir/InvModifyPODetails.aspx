<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvModifyPODetails.aspx.cs" Inherits="Jawan.Portal.InvModifyPODetails" %>
...
<head id="Head1" runat="server">
    ...
    <title>INVENTORY: MODIFY PO DETAILS</title>
            ...
            <div class="content-holder">
                <div id="breadcrumb">
                    <ul class="crumbs">
                        ...
                        <li class="active"><a href="InvPODetails.aspx" style="z-index: 7;" class="active_bread">Modify PO Details</a></li>
                    </ul>
                </div>
                    ...
                    <div class="contentarea" id="contentarea">
                        ...
                        <div class="sidebox">
                            <div class="boxhead">
                                ...
                                <h2 style="text-align: center">Modify PO Details
                                </h2>
                            </div>
                                        ...
                                        <li class="right">
                                            <asp:UpdatePanel ID="uppanel" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                                                <ContentTemplate>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table width="100%" cellpadding="5" cellspacing="5" style="margin: 10px">
                                                                    ...
                                                                    <tr style="height: 36px">
                                                                        <td> <asp:Label ID="lblmonth" runat="server" Text="Month" Visible="false"></asp:Label></td>
                                                    ...
                                                    <div class="rounded_corners" style="width: 125%; margin-left: -1px; margin-top: 16px;overflow-x:scroll">
                                                        <asp:GridView ID="GVInvPODetails" runat="server" AutoGenerateColumns="False" Width="125%" CssClass="table table-striped table-bordered table-condensed table-hover"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Item Name" ItemStyle-HorizontalAlign="Left">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblitemname" runat="server" Text='<%#Bind("itemname") %>' Width="150px"></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>

                                                                   <asp:TemplateField HeaderText="HSN Number" ItemStyle-HorizontalAlign="Left">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblHSNNo" runat="server" Text='<%#Bind("HSNNumber") %>' Width="150px"></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Quantity" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="50px">
                                                                    <ItemTemplate>
                                                                        <asp:TextBox ID="txtQuantity" runat="server" Text='<%#Bind("Qty","{0:0.##}") %>' CssClass="form-control" Width="50px" AutoPostBack="true" OnTextChanged="txtQuantity_OnTextChanged"></asp:TextBox>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Total Buying Price" HeaderStyle-Width="90px">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblTotalBuyingPrice" runat="server" Text='<%#Bind("TotalBuyingPrice","{0:0.##}") %>' Width="90px"></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                 ...
                                                                 <asp:TemplateField HeaderText="GST Amt." HeaderStyle-Width="90px">
                                                                    <ItemTemplate>
                                                               ...
                                                               <asp:TemplateField HeaderText="VATCmp1" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="90px">
                                                                ...
                                                                <asp:TemplateField HeaderText="Sub Total" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="100px">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblSubTotal" runat="server" Text="" HeaderStyle-Width="100px"></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
