<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LicenceDetailsReports.aspx.cs" Inherits="Jawan.Portal.LicenceDetailsReports" %>
...
<head id="Head1" runat="server">
    ...
    <title>rEPORT: LICENSE DETAILS REPORT</title>
...
<body>
    <form id="LicenceDetailsReports1" runat="server">
                ...
                <div class="dashboard_center">
                    ...
                    <asp:ScriptManager runat="server" ID="ScriptEmployReports"></asp:ScriptManager>
                              ...
                              <tr>
                                  <td>
                                    ...
                                    <td>   <asp:DropDownList runat="server" class="sdrop" ID="ddlClientId"  AutoPostBack="true"
                                              onselectedindexchanged="ddlClientId_SelectedIndexChanged"></asp:DropDownList></td>
                                   <td>  Client Name :</td>
                       ...
                       <asp:GridView ID="dgLicExpire" runat="server" AllowPaging="True" 
                           ...
                           ForeColor="#333333" CellPadding="5" CellSpacing="5">
