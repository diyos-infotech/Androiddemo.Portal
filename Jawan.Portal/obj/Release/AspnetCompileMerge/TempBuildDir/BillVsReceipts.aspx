<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BillVsReceipts.aspx.cs" Inherits="Jawan.Portal.BillVsReceipts" %>
            ...
            <div class="content-holder">
                <div id="breadcrumb">
                    <ul class="crumbs">
                        ...
                        <li class="active"><a href="BillsVsReceipts.aspx" style="z-index: 8;" class="active_bread">Bills Vs Receipts</a></li>
                    </ul>
                </div>
            ...
            <div id="footerouter">
                <div class="footer">
                    <div class="footerlogo">
                        <a href="http://www.diyostech.Com" target="_blank">Powered by DIYOS                         <a href="#">Terms &amp; Conditions</a> | <a href="#">Privacy Policy</a> | ©
