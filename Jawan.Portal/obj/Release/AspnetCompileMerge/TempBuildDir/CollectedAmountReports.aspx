<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CollectedAmountReports.aspx.cs" Inherits="Jawan.Portal.CollectedAmountReports" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>REPORT: COLLECTED AMOUNT REPORT</title>
...
<body>
  <form id="CollectedAmountReports1" runat="server">
                ...
                <ul>
                   <li class="left leftmenu">
                       <ul>
                          ...
                          <li><a href= "CollectedAmountReports.aspx" class="sel">Collected Amount </a>   </li>
