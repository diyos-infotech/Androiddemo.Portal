<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportESINos.aspx.cs" Inherits="Jawan.Portal.ImportESINos" %>
                                ...
                                <div class="dashboard_firsthalf" style="width: 100%">
                                    <table width="60%" cellpadding="5" cellspacing="5">
                                       <tr>
                                        ...
                                        <td >
                                          <asp:FileUpload ID="FlUploadESI" runat="server" />
                                        </td>
                                        <td >
                                   ...
                                   <asp:GridView ID="GvNotInsertedlist" runat="server" AutoGenerateColumns="False" Width="90%" Visible="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="ESI No">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblEsiNo" Text="<%#Bind('ESINo')%>"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Remarks">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblEsiNo" Text="<%#Bind('Remark')%>"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
