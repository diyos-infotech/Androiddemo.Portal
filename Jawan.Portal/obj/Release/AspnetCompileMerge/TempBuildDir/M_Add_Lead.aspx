<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="M_Add_Lead.aspx.cs" Inherits="Jawan.Portal.M_Add_Lead" %>
...
<body>
    <form id="AddLead" runat="server" autocomplete="off">
                        ...
                        <ContentTemplate>
                            ...
                            <table cellpadding="5" cellspacing="5" width="100%" style="margin: 10px; margin-left: 20px;">
                                <tr style="height: 32px">
                                    <td>
                                        <asp:Label ID="lblLeadID" runat="server" Text="Lead ID" Style=""></asp:Label>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:Label ID="lblleadname" runat="server" Text="Company Name"></asp:Label><span style="color: Red">*</span>
                                    </td>
                                    <td>
                                ...
                                <tr style="height: 32px">
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlLeadGenratedby" TabIndex="6" runat="server" CssClass="ddlautocomplete chosen-select"  AutoPostBack="True">
                                ...
                                <tr style="height: 32px">
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlpreStates" runat="server"  OnSelectedIndexChanged="ddlpreStates_SelectedIndexChanged1" TabIndex="9" AutoPostBack="True">
                                        </asp:DropDownList>
                                    </td>
                                    <td></td>
                                    <td>City
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlpreCity" runat="server" AutoPostBack="True" Enabled="false" TabIndex="10"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr style="height: 32px">
                                    <td>Address</td>
                                    <td>
                                        <asp:TextBox runat="server" ID="txtAddress" TextMode="MultiLine" TabIndex="11" MaxLength="10"></asp:TextBox>
                                    </td>
                                    <td></td>
                                    <td>Branch
                                    </td>
                            ...
                            <table>
                                <tr style="font-weight: bold; height: 32px">
                                    <td colspan="2" style="display: none">Region
                                    </td>
                           ...
                           <table cellpadding="5" cellspacing="5" width="100%" style="margin: 10px; margin-left: 20px;">
                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" GridLines="None"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Salary" ItemStyle-HorizontalAlign="Left" HeaderStyle-BackColor="#fcf8e3">
                                     ...
                                     <%-- 4 --%>
                                    <asp:TemplateField HeaderText="Hours" HeaderStyle-BackColor="#fcf8e3">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtHours" runat="server" Text="" placeholder="Hours" TabIndex="20" Width="150px" Style="margin: 4px; height: 35px"></asp:TextBox>
                                    ...
                                    <asp:TemplateField HeaderText="Strength" HeaderStyle-BackColor="#fcf8e3">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtStrength" runat="server" Text="" placeholder="Strength" TabIndex="21" Width="150px" Style="margin: 4px; height: 35px"></asp:TextBox>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:ImageButton ID="imgdelete" ImageUrl="~/Marketing_Images/Deleteicon.png" OnClientClick='return confirm("Are you sure you want to delete this entry?");' runat="server" OnClick="imgdeleteexist_Click" />
                                        </ItemTemplate>
                            ...
                            <asp:GridView ID="GVleads" runat="server" AutoGenerateColumns="False" GridLines="None"
                                ShowHeader="false" CellPadding="15" CellSpacing="5" Style="text-align: center; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif" HeaderStyle-HorizontalAlign="Center">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Name" HeaderStyle-BackColor="#fcf8e3">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtname" placeholder="Name" runat="server" Text="" TabIndex="21" AutoPostBack="true" Width="200px" Style="margin: 4px; height: 35px"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Designation" ItemStyle-HorizontalAlign="Left" HeaderStyle-BackColor="#fcf8e3">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtdesgn" runat="server" placeholder="Designation" TabIndex="22" Width="200px" Text="" Style="margin: 4px; height: 35px" AutoPostBack="true"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Mobile" ItemStyle-HorizontalAlign="Left" HeaderStyle-BackColor="#fcf8e3">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtmobile" runat="server" Text="" placeholder="Mobile" TabIndex="23" Width="200px" Style="margin: 4px; height: 35px" AutoPostBack="true"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="E-Mail" HeaderStyle-BackColor="#fcf8e3">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtemail" runat="server" Text="" placeholder="E-mail" TabIndex="24" Width="200px" Style="margin: 4px; height: 35px" AutoPostBack="true"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Actions">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="imgdelete" ImageUrl="~/Marketing_Images/Deleteicon.png" OnClientClick='return confirm("Are you sure you want to delete this entry?");' runat="server" OnClick="imgdelete_Click" />
                                        </ItemTemplate>
                                        <ItemStyle Width="40px"></ItemStyle>
                                        <HeaderStyle HorizontalAlign="Center" />
                                    </asp:TemplateField>
                            ...
                            <div align="right">
                                <asp:ImageButton ID="Imgadd" ImageUrl="~/Marketing_Images/Addicon.png" ToolTip="Add" runat="server" OnClick="Imgadd_Click" />
                            </div>

                            <div align="right" style="margin-top: 10px">
                                <asp:Button ID="btnsavedetails" runat="server" Text="Save" TabIndex="25"
                                    ToolTip="Save Details" class=" btn save" Visible="true" OnClick="btnsavedetails_Click" />
                            </div>
