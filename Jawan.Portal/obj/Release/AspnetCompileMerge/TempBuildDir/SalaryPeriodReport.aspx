<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalaryPeriodReport.aspx.cs" Inherits="Jawan.Portal.SalaryPeriodReport" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>REPORT: SALARY REPORT</title>
        ...
        <div class="content-holder">
            <div id="breadcrumb">
                <ul class="crumbs">
                    ...
                    <li class="active"><a href="#" style="z-index: 7;" class="active_bread">Salary Period
                        Report</a></li>
                </ul>
            </div>
                            ...
                            <div class="boxin">
                                ...
                                <div class="rounded_corners">
                                    <div style="overflow: scroll; height: auto; width: auto">
                                        <asp:GridView ID="GVListEmployees" runat="server" AutoGenerateColumns="False" Width="150%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Gross" HeaderText="Gross" DataFormatString="{0:0}" />
                                                <asp:BoundField DataField="PF" HeaderText="PF" DataFormatString="{0:0}" />
                                                <asp:BoundField DataField="ESI" HeaderText="ESI" DataFormatString="{0:0}" />
                                                <asp:BoundField DataField="ProfTax" HeaderText="PT" DataFormatString="{0:0}" />
                                                <asp:BoundField DataField="SalAdvDed" HeaderText="S.A" DataFormatString="{0:0}" />
                                                <asp:BoundField DataField="CanteenAdv" HeaderText="C.A" DataFormatString="{0:0}" />
                                                <asp:BoundField DataField="UniformDed" HeaderText="U.D" DataFormatString="{0:0}" />
                                                <asp:BoundField DataField="OtherDed" HeaderText="O.D" DataFormatString="{0:0}" />
