<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClientBilling.aspx.cs" Inherits="Jawan.Portal.ClientBilling" %>
...
<body>
    <form id="ClientBilling1" runat="server">
        <div id="headerouter">
                                ...
                                <div style="display: inline;">
                                  ...
                                  <div class="submenuactions">
                                        ...
                                        <ul>
                                            ...
                                            <li class="current"><a href="Clientbilling.aspx" id="BillingLink" runat="server"><span>Billing</span></a></li>
                                            ...
                                            <table cellpadding="5" cellspacing="5" width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btngenratepayment"
                                                        runat="server" class="btn save" Text="Genrate Bill" OnClick="Btn_Genrate_Invoice_Click" Style="margin-left: 20px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="HSN Number" HeaderStyle-Width="60px">
                                                    <ItemTemplate>
                                                        ...
                                                        <br />
                                                        <br />
                                                        <asp:TextBox ID="txtUOM" runat="server" Text='<%# Bind("UOM") %>' Style="width: 50px"></asp:TextBox>
                                                ...
                                                <%-- 8 --%>
                                                <asp:TemplateField HeaderText="NOD" Visible="false" HeaderStyle-Width="50px">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Total" HeaderStyle-Width="70px">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="lblAmount" runat="server" Text="" Enabled="false" Width="99%"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="text-align: right; font-weight: bold">
                                                <asp:Button ID="Button2" runat="server" Text="Invoice New" class="btn save" OnClick="btninvoiceNewformat_Click" /><br />
                                            </td>

                                            <td style="text-align: right; font-weight: bold">
                                                <asp:Button ID="btninvSft" runat="server" Text="Invoice Sft" class="btn save" OnClick="btninvoiceSftformat_Click" /><br />
                                            </td>
                                            ...
                                            <td style="text-align: right; font-weight: bold">
                                                <asp:Button ID="Button4" runat="server" Text="Invoice PDF" Visible="false" class="btn save" OnClick="btnnewGSTformat_Click" /><br />
                                            </td>
