<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmpTransferDetailReports.aspx.cs" Inherits="Jawan.Portal.EmpTransferDetailReports" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>REPORT: EMPLOYEE TRANSFER REPORT</title>
        ...
        <div class="content-holder">
            <div id="breadcrumb">
                <ul class="crumbs">
                    ...
                    <li class="active"><a href="#" style="z-index: 7;" class="active_bread">EMP Transfer
                        Details</a></li>
                </ul>
            </div>
                                    ...
                                    <asp:GridView ID="GVListEmployees" runat="server" AutoGenerateColumns="False" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Order Id">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblorderid" Text="<%# Bind('Orderid') %>"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Unit ID">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblEmpMiddleName" Text="<%# Bind('tounitid') %>"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
