<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifyInflowDetails.aspx.cs" Inherits="Jawan.Portal.ModifyInflowDetails" %>
...
<head id="Head1" runat="server">
    ...
    <title>INVENTORY: MODIFY INFLOW DETAILS</title>
    ...
    <script type="text/javascript">
        ...
        function setProperty() {
            ...
            $(".ddlautocomplete").combobox({
                ...
                select: function (event, ui) { $("#ddlInflowID").attr("data-clientId", ui.item.value); OnAutoCompleteDDLInfowIDchange(event, ui); },
        ...
        function OnAutoCompleteDDLInfowIDchange(event, ui) {
