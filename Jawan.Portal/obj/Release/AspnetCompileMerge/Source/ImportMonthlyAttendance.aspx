<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportMonthlyAttendance.aspx.cs" Inherits="Jawan.Portal.ImportMonthlyAttendance" %>
            ...
            <div id="mainmenu">
                <ul>
                    <li class="first"><a href="Employees.aspx" id="EmployeesLink" runat="server"><span>
                        Employees</span></a></li>
                    <li><a href="clients.aspx" id="ClientsLink" runat="server" ><span>
                        Clients</span></a></li>
                    <li class="after"><a href="companyinfo.aspx" id="CompanyInfoLink" runat="server"><span>
                        Company Info</span></a></li>
                    <li><a href="ViewItems.aspx" id="InventoryLink" runat="server"><span>Inventory</span></a></li>
                    <li><a href="ActiveEmployeeReports.aspx" id="ReportsLink" runat="server" class="current"><span>
                        Reports</span></a></li>
                                  ...
                                  <ul>
                                   <li><a href="Employees.aspx" id="AddEmployeeLink" runat="server"><span>Add</span></a></li>
                                        ...
                                        <li><a href="EmployeeAttendance.aspx" id="AttendanceLink" runat="server">
                                            ...
                                            <li class="current"><a href="ImportMonthlyAttendance.aspx" id="ImportMonthlyAttendanceLink" runat="server">
                                            <span>Emp Attendance</span></a></li>
                            ...
                            <asp:Label ID="lblGTotOts" runat="server"></asp:Label>
                                ...
                                <asp:GridView ID="grvSample2" runat="server"  Width="100%"
                                    ...
                                    <asp:TemplateField HeaderText="Duties" FooterStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5px">
                                        ...
                                        <asp:TemplateField HeaderText="NHs" FooterStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5px">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="txtsNhs" style="text-align:center" Width="5px" Text=" <%#Bind('day3')%>"></asp:Label>
                                            </ItemTemplate>
                                       </asp:TemplateField>
