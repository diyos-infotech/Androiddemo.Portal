<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiveReports.aspx.cs" Inherits="Jawan.Portal.ReceiveReports" %>
    ...
    <script type="text/javascript">
        ...
        function setProperty() {
            ...
            $(".ddlautocomplete").combobox({
                select: function (event, ui) { $("#ddlclient").attr("data-clientId", ui.item.value); OnAutoCompleteDDLClientidchange(event, ui); },
            ...
            <div id="header">
                ...
                <div id="mainmenu">
                    <ul>
                        ...
                        <li><a href="companyinfo.aspx" id="CompanyInfoLink" runat="server"><span>Branch Info</span></a></li>
