<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeactivateEmployeeWhenattendancezero.aspx.cs" Inherits="Jawan.Portal.DeactivateEmployeeWhenattendancezero" %>
...
<head id="Head1" runat="server">
    ...
    <title>DEACTIVATE EMPLOYEE BASED ON ATTENDANCE</title>
        ...
        <div class="content-holder">
            <div id="breadcrumb">
                <ul class="crumbs">
                    ...
                    <li class="active"><a href="#" style="z-index: 7;" class="active_bread">Deactivate Employees</a></li>
                </ul>
            </div>
                        ...
                        <div class="boxbody" style="padding: 5px 5px 5px 5px;">
                            <div class="boxin">
                                ...
                                <div class="dashboard_firsthalf" style="width: 100%">
                                    <div align="right">
                                        <asp:LinkButton ID="lbtn_Export" runat="server" OnClick="lbtn_Deactivate_Click">Deactivate Employees</asp:LinkButton>
                                    </div>
                                    <table width="100%" cellpadding="5" cellspacing="5">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlclientid" class="sdrop" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlclientid_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </td>
                                            <td width="60px">
                                               Name :
                                ...
                                <div style="overflow: scroll" class="round-corners">
                                    <asp:GridView ID="GVListEmployees" runat="server" AutoGenerateColumns="False" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="EmpMname" HeaderText="Emp Name" />
