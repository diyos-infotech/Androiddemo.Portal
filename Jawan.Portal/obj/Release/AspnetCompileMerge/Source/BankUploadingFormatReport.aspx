<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BankUploadingFormatReport.aspx.cs" Inherits="Jawan.Portal.BankUploadingFormatReport" %>
...
<head id="Head1" runat="server">
    ...
    <title>REPORT: BANK UPLOADING</title>
                                    ...
                                    <asp:GridView ID="GVListEmployees" runat="server" AutoGenerateColumns="False" Width="100%"
                                       CellSpacing="3" CellPadding="4" ForeColor="#333333" GridLines="None">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="EmpBankAcNo" HeaderText="Bank A/C No" />
                                            <asp:BoundField DataField="EmpBankCardRef" HeaderText="Reference No" />
                                        </Columns>
