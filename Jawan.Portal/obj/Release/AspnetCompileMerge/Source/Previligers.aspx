<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Previligers.aspx.cs" Inherits="Jawan.Portal.Previligers" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>PREVILAGES</title>
                                    ...
                                    <asp:GridView ID="gvpreviligers" runat="server" AutoGenerateColumns="false" Width="100%"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Previliger Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblpreviligername" runat="server" Text="<%#Bind('previligerName') %>"></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <asp:TextBox ID="txtpreviligerName" runat="server" Text="<%#Bind('previligerName') %>"
                                            ...
                                            <asp:TemplateField HeaderText="Id">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblpreviligerid" runat="server" Text="<%#Bind('previligerid') %>"></asp:Label>
                                                </ItemTemplate>
                                                <EditItemTemplate>
                                                    <asp:Label ID="lblpreviligerid" runat="server" Text="<%#Bind('previligerid') %>"></asp:Label>
                                                </EditItemTemplate>
