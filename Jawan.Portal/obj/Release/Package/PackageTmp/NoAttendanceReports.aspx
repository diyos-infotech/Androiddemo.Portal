<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoAttendanceReports.aspx.cs" Inherits="Jawan.Portal.NoAttendanceReports" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>REPORT: ZERO ATTENDANCE REPORT</title>
...
<body>
    <form id="NoAttendanceReports1" runat="server">
        ...
        <div class="content-holder">
             <div id="breadcrumb">
                <ul class="crumbs">
                    ...
                    <li class="active"><a href="#" style="z-index: 7;" class="active_bread"> No Attendance</a></li>
                </ul>
            </div>
                                ...
                                <asp:GridView ID="GVListEmployees" runat="server" AutoGenerateColumns="False" Width="100%" Height="50px"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Name">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblclientid" Text="<%# Bind('Empmname') %>"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
