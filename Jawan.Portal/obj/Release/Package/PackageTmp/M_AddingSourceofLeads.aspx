<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="M_AddingSourceofLeads.aspx.cs" Inherits="Jawan.Portal.M_AddingSourceofLeads" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>SETTINGS: ADD Source of Leads</title>
            ...
            <div class="content-holder">
                <div id="breadcrumb">
                    <ul class="crumbs">
                        ...
                        <li class="active"><a href="#" style="z-index: 7;" class="active_bread">SourceofLeads</a></li>
                    </ul>
                </div>
                ...
                <div class="contentarea" id="contentarea">
                    <div class="dashboard_center">
                        <div class="sidebox">
                            <div class="boxhead">
                                <h2 style="text-align: center">Source of Leads
                                </h2>
                            </div>
                                ...
                                <div class="boxin">
                                    <div class="dashboard_firsthalf" style="width: 100%">
                                        <table width="45%">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblsegment" runat="server" Text="Source Name :" class="fontstyle"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:TextBox ID="Txt_Bank_Name" runat="server" class="sinput"></asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:Button ID="Btn_Bank_Name_Add" runat="server" Text="Add Source of Lead" class="btn save"
                                                        Width="120px" OnClick="Btn_Bank_Name_Add_Click" OnClientClick='return confirm(" Are you sure you want to add the Source of Lead?");' />
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="rounded_corners">
                                        <asp:GridView ID="gvbank" runat="server" AutoGenerateColumns="false" Width="100%"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Source of Lead" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Left"
                                                    HeaderStyle-Width="70%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblbankName" runat="server" Text="<%#Bind('SourceofLead') %>"></asp:Label>
                                                    </ItemTemplate>
                                                    <EditItemTemplate>
                                                        <asp:TextBox ID="txtbankName" runat="server" Text="<%#Bind('SourceofLead') %>" Width="500px"></asp:TextBox>
                                                    </EditItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="ID" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                    HeaderStyle-Width="10%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblbankid" runat="server" Text="<%#Bind('SourceId') %>"></asp:Label>
                                                    </ItemTemplate>
                                                    <EditItemTemplate>
                                                        <asp:Label ID="lblbankid" runat="server" Text="<%#Bind('SourceId') %>"></asp:Label>
                                                    </EditItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="OPERATIONS" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center"
                                                    ...
                                                    <EditItemTemplate>
                                                        <asp:LinkButton ID="linkupdate" runat="server" CommandName="update" Text="Update"
                                                            OnClientClick='return confirm(" Are you  sure you  want to update  the Source of Lead?");' Style="color: Black"></asp:LinkButton>
                                                        <asp:LinkButton ID="linkcancel" runat="server" CommandName="cancel" Text="Cancel"
                                                            OnClientClick='return confirm(" Are you  sure you  want to cancel  the Source of Lead?");' Style="color: Black"></asp:LinkButton>
                                                    </EditItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
