<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportAadhaarNo.aspx.cs" Inherits="Jawan.Portal.ImportAadhaarNo" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>IMPORT AadharCard NOS.</title>
                                ...
                                <div class="dashboard_firsthalf" style="width: 100%">
                                   ...
                                   <asp:GridView ID="GvNotInsertedlist" runat="server" AutoGenerateColumns="False" Width="90%" Visible="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Aadhaar No">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblAadhaarNo" Text='<%#Eval("AadharCardNo","{0:X}")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                 ...
                                 <asp:GridView ID="gvlistofemp" runat="server" AutoGenerateColumns="False" Width="90%" Visible= "false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Aadhaar No">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblAadhaarNo" Text='<%#Eval("AadharCardNo","{0:x4}")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
