<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnitWiseGrossReports.aspx.cs" Inherits="Jawan.Portal.UnitWiseGrossReports" %>
...
<head id="Head1" runat="server">
    ...
    <title>REPORT: CLIENTWISE GROSS REPORT</title>
        ...
        <div id="header">
            ...
            <div id="mainmenu">
                <ul>
                    ...
                    <li><a href="Reports.aspx" id="ReportsLink" runat="server" class="current"><span>
                        Reports</span></a></li>
        ...
        <div class="content-holder">
            <div id="breadcrumb">
                <ul class="crumbs">
                    ...
                    <li class="active"><a href="#" style="z-index: 7;" class="active_bread">Gross and PF</a></li>
                </ul>
            </div>
                                    ...
                                    <div align="right">
                                        ...
                                        <table width="100%" cellpadding="5" cellspacing="5">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlpftype" runat="server" class="sdrop">
                                                ...
                                                <td>
                                                 ...
                                                 <asp:DropDownList ID="ddlmonth" runat="server" class="sdrop" Width="80px" style="margin-left:10px">
                                    ...
                                    <div class="rounded_corners">
                                        <asp:GridView ID="GVListEmployees" runat="server" AutoGenerateColumns="False" Width="100%"
                                            ...
                                            <Columns>
                                                ...
                                                <%--   <asp:BoundField DataField="PFWAGES" HeaderText="EPF Wages" DataFormatString="{0:0.00}" />--%>
                                                <asp:TemplateField HeaderText="EPF Wages">
                                                    <ItemTemplate>
                                                        <asp:Label Text="<%# Bind('PFWAGES') %>" ID="lblPFWAGES" runat="server"> </asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                        <asp:Label ID="lblTotalPFWAGES" runat="server" Text=""></asp:Label>
                                                    </FooterTemplate>
                                                </asp:TemplateField>
                                                <%--  <asp:BoundField DataField="PF" HeaderText="EPF EMP Share" DataFormatString="{0:0.00}" />--%>
                                                <asp:TemplateField HeaderText="EPF EMP Share">
                                                    <ItemTemplate>
                                                ...
                                                <%-- <asp:BoundField DataField="PFEmpr" HeaderText="EPF EMPR Share" DataFormatString="{0:0.00}" />--%>
                                                <asp:TemplateField HeaderText="EPF EMPR Share">
                                                    <ItemTemplate>
                                                        <asp:Label Text="<%# Bind('PFEmpr') %>" ID="lblPFEmpr" runat="server"> </asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                        <asp:Label ID="lblTotalPFEmpr" runat="server" Text=""></asp:Label>
                                                    </FooterTemplate>
                                                </asp:TemplateField>
                                                <%-- <asp:BoundField DataField="TotalPF" HeaderText="Total Pf" DataFormatString="{0:0.00}" />--%>
                                                <asp:TemplateField HeaderText="Total Pf">
                                                    <ItemTemplate>
                                                        <asp:Label Text="<%# Bind('TotalPF') %>" ID="lblTotalPF" runat="server"> </asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                        <asp:Label ID="lblTotalTotalPF" runat="server" Text=""></asp:Label>
                                                    </FooterTemplate>
                                                </asp:TemplateField>
                                            </Columns>
