<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WageSheetReportsonlyots.aspx.cs" Inherits="Jawan.Portal.WageSheetReportsonlyots" %>
                                ...
                                <asp:GridView ID="GVListEmployees" runat="server" AutoGenerateColumns="False" Width="100%"
                                   CellSpacing="3" CellPadding="5" ForeColor="#333333" GridLines="None" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ots" HeaderText="No Of OT's" DataFormatString="{0:0.00}" />
