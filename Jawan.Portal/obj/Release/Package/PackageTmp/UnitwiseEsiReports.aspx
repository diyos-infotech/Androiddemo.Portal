<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnitwiseEsiReports.aspx.cs" Inherits="Jawan.Portal.UnitwiseEsiReports" %>
...
<head id="Head1" runat="server">
    ...
    <title>REPORT: CLIENTWISE ESI REPORT</title>
...
<body>
    <form id="UnitwiseEsiReports1" runat="server">
        ...
        <div class="content-holder">
            <div id="breadcrumb">
                <ul class="crumbs">
                    ...
                    <li class="active"><a href="#" style="z-index: 7;" class="active_bread">Gross and ESI</a></li>
                </ul>
            </div>
                            ...
                            <div class="boxin">
                                    ...
                                    <div align="right">
                                        ...
                                        <table width="100%" cellpadding="5" cellspacing="5">
                                           ...
                                           <tr>
                                               <td>
                                                    Select Esi Type :</td>
                                                  <td>  <asp:DropDownList ID="ddlesitype" runat="server" class="sdrop">
                                               ...
                                               <td>
                                                    ...
                                                    <asp:DropDownList ID="ddlmonth" runat="server"  class="sdrop" Width="80" style="margin-left:10px">
                              ...
                              <td style=" width:25%">
                                  ...
                                  <asp:DropDownList ID="ddlAttendance" runat="server"  >
                                    ...
                                    <div class="rounded_corners">
                                        <asp:GridView ID="GVListEmployees" runat="server" AutoGenerateColumns="False" Width="100%"
                                            Height="50px" CellSpacing="3" CellPadding="4" ForeColor="#333333" GridLines="None"
                                  ...
                                  <asp:Label runat="server" ID="lblclientname" Text="<%# Bind('ClientName') %>"></asp:Label>
                                        ...
                                        <asp:BoundField  DataField="washallowance" HeaderText="(Gross-WA)" DataFormatString="{0:0.00}"/>
                                        ...
                                        <asp:BoundField  DataField="ESIeMPR" HeaderText="ESIEmpr" DataFormatString="{0:0.00}"/>
