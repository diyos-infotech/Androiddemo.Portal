<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifyEmployee.aspx.cs" Inherits="Jawan.Portal.ModifyEmployee" %>
...
<body>
    <form id="ModifyEmployee1" runat="server">
        <div id="headerouter">
                            ...
                            <td>
                                <div style="display: inline;">
                                    <div id="submenu" class="submenu">
                                        ...
                                        <li class="current"><a href="ModifyEmployee.aspx" id="ModifyEmployeeLink" runat="server">
                ...
                <div class="col-md-12" style="margin-top: 8px; margin-bottom: 8px">
                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            ...
                            <div id="tabs" style="height: auto; margin-top: 18px">
                                <ul>
                                ...
                                <div id="tabs-1" style="height: 1000px">
                                    ...
                                    <asp:UpdatePanel runat="server" ID="uppersonal">
                                        <ContentTemplate>
                                            ...
                                            <asp:Panel ID="Pnlpersonal" Enabled="false" runat="server" GroupingText="<strong>&nbsp;Images&nbsp;</strong>" Style="margin-top: 10px">
                                                ...
                                                <div class="dashboard_secondhalf">
                                                    <table cellpadding="5" cellspacing="5">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtEmpDtofBirth" TabIndex="8" runat="server" class="sinput" MaxLength="10" AutoComplete="off"></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtEmpDtofJoining" TabIndex="21" runat="server" class="sinput" size="20"
                                                                    MaxLength="10" OnTextChanged="txtEmpDtofJoining_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtEmergContNo" MaxLength="12" runat="server" class="sinput">
                                                                </asp:TextBox>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Enabled="true" Format="dd/MM/yyyy" TargetControlID="TxtIDCardIssuedDt">
                                                                </cc1:CalendarExtender>
                                                                <cc1:FilteredTextBoxExtender ID="FtBIDCardIssuedDt" runat="server" Enabled="True" TargetControlID="TxtIDCardIssuedDt" ValidChars="/0123456789">
                                                                </cc1:FilteredTextBoxExtender>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                    ...
                                    <asp:Panel ID="pnlimages" runat="server" Enabled="false" GroupingText="<strong>&nbsp;Images&nbsp;</strong>" Style="margin-top: 10px">
                                        ...
                                        <div class="dashboard_Secondhalf">
                                            <table cellpadding="5" cellspacing="5" style="margin-top: 10px">
                                                <tr>
                                                    <td style="padding-left: 18px">File</td>
                                                    <td style="font: bold; font-size: medium">
                                                        <asp:Image ID="ImgPassBookFront" runat="server" Visible="false" Height="5" Width="5" Style="margin-left: 25px" />&nbsp;
                                                        <asp:Literal ID="ltbankpassbookfront" runat="server" />
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:FileUpload ID="FileUploadPassBookFront" runat="server" Width="200px" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                                ...
                                                <div class="dashboard_secondhalf" style="padding: 10px">
                                                    <table cellpadding="5" cellspacing="5">
                                                        ...
                                                        <%--  <tr>
                                                            <td style="padding-left: 18px">KYC Name</td>
                                                            <td>
                                                                <asp:TextBox ID="TextBox2" runat="server" class="sinput" Enabled="false" Style="margin-left: 5px"></asp:TextBox>
                                                            </td>
                                                        </tr>--%>
                                                    </table>
                                                </div>
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Font-Size="Small" HeaderStyle-HorizontalAlign="Center" HeaderStyle-BackColor="#EFF3FB"
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <cc1:FilteredTextBoxExtender ID="ftbrelphone" runat="server" Enabled="True"
                                                                        TargetControlID="txtRelphnno" FilterMode="ValidChars" FilterType="Numbers">
                                                                    </cc1:FilteredTextBoxExtender>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" Font-Size="Small"></HeaderStyle>
                                                                <ItemStyle HorizontalAlign="Center" Font-Size="Small"></ItemStyle>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-Font-Size="Small" HeaderStyle-HorizontalAlign="Center" HeaderStyle-BackColor="#EFF3FB"
                                                                ...
                                                                <ItemTemplate>
                                                                    ...
                                                                    <cc1:FilteredTextBoxExtender ID="ftbrelmail" runat="server" Enabled="True"
                                                                        TargetControlID="txtRelmail" FilterMode="ValidChars" FilterType="Numbers,UppercaseLetters, LowercaseLetters, Custom" ValidChars=".@">
                                                                    </cc1:FilteredTextBoxExtender>
                                                                </ItemTemplate>
                                                                <HeaderStyle HorizontalAlign="Center" Font-Size="Small"></HeaderStyle>
                                                                <ItemStyle HorizontalAlign="Center" Font-Size="Small"></ItemStyle>
